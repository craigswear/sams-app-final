...
import { Users, BookMarked } from 'lucide-react'; // Import BookMarked icon

// Simple styles for the link card, can be moved to a .module.css file later
...
export default function AdminPage() {
    ...
    return (
        ...
        <div style={gridStyle}>
            ...
            {/* Link to the new accommodations page */}
